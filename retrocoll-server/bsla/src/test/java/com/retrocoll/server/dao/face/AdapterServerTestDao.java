...
*/
package com.retrocoll.server.dao.face;
...
@ContextConfiguration(locations={
     "classpath:com/retrocoll/server/factory/spring/spring-config-Server-BE-main.xml"
})
@TransactionConfiguration(transactionManager = "serverTransactionManager") 
@Transactional
public class AdapterServerTestDao extends AbstractTransactionalJUnit4SpringContextTests { 

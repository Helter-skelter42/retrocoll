...
public class Location_ {
    ...
    public static volatile SetAttribute<Location, Accessorie> accessorieLocationViaLocation;
    public static volatile SetAttribute<Location, Hardware> hardwareLocationViaLocation;
    public static volatile SetAttribute<Location, Software> softwareLocationViaLocation;
